package cool.zzy.sems.ui.coordinatortablayout;
...
import cool.zzy.sems.ui.coordinatortablayout.listener.LoadHeaderImagesListener;
import cool.zzy.sems.ui.coordinatortablayout.listener.OnTabSelectedListener;
...
public class CoordinatorTabLayout extends CoordinatorLayout {
    ...
    public CoordinatorTabLayout setBackEnable(Boolean canBack) {
        if (canBack && mActionbar != null) {
            ...
            mActionbar.setHomeAsUpIndicator(R.drawable.ic_baseline_menu_24);
        }
        return this;
    }
